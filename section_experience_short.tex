...
\begin{experiences}
  ...
  {September 2018}   {
                      \begin{itemize}
                        ...
                        \item Designed and built tooling to enable customer support to better engage with customers by provide detailed analysis of Fitbit device batteries
                      \end{itemize}
                  }
                  {}
  \experience
  ...
  {January 2016}   {
                      \begin{itemize}
                        ...
                        \item Built full stack functionality to support product sales on the Fitbit.com commerce platform. Including but not limited to: product warranties, fraud prevention, and product launch support.
                      \end{itemize}
                  }
